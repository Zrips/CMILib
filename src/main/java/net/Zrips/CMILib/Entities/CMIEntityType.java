...
public enum CMIEntityType {
    ...
    PALE_OAK_BOAT(),
    PALE_OAK_CHEST_BOAT(),
    CREAKING(Arrays.asList(
            "ZGUzNzNmYTUzNGM3YzNmOTM0MGQzM2MzMmMyMTM0MDJhMmNmODkxN2U3NTBlYjhiYzg3MTBmY2QzZWU5YTE1ZCJ9fX0=")),
    CREAKING_TRANSIENT(),

    // 1.21.9
    COPPER_GOLEM(Arrays.asList(
            "OTllMjRlOTRkYmU0MmUyMzBkODMyOTNhNzdkNjFmZjcxMDFhOGM2OGFiNjhiYmM2YTkzZjk2MzBmYjJmZGI0In19fQ==",
            "Y2MyYWFiOGEwZmVjM2NjMDZhNGQ0NzQ4MGUwMjRmODhmMmIwN2JjOTZlZTA5ZTUzMzFlNWY0ZGI2YjI3Mzg4NSJ9fX0=",
            "OTgyZDVjOTQ0ZjgwNzk1ZDYxM2MyMjQwNWMwMjdlZGJkMmE1NTQ0ODgyYWNiYWI5NzRhMDJmNTQ3YzE1NDY4ZCJ9fX0=")),
    MANNEQUIN(),

    HAPPY_GHAST(Arrays.asList(
            "YTFhMzZjYjkzZDAxNjc1YzQ2MjJkZDVjOGQ4NzIxMTA5MTFlYzEyYzM3MmU4OWFmYThiYTAzODYyODY3ZjZmYiJ9fX0=",
            "ZWM3OWY5MDgyZjZhYmVlZDk3NTA3NDQ0M2JlOGM4YTc5ZWExMDYwZDYxMDk0ZmY3OWEwNDk4OTM0MDQzMDYyNCJ9fX0=",
            "MjRiNWE0NzJkY2U5MzUwNWQ0YTQ0MDFhNzRjZTI5ZWNlZTg4ZTMyNjQyOGJjMTAzY2JhZDRkOTM5YWJlZDFiIn19fQ==")),

    // 1.21.11
    CAMEL_HUSK(Arrays.asList(
            "M2JkN2E5MmE2ZjY3Yjc1MDBkMTZjNGUxMmYyODA1OGVjMjg1OTMxMTU1NmJhMDNiZTJkMWY1ODExNzBmMmRiNiJ9fX0=")),
    NAUTILUS(Arrays.asList(
            "M2JiMzQwZGQzMzAyNjE1MzQ4ZGU1MTYyZmUxNjcwYjljNWM5YzYxNmNkOTJkMmRlOWQ4Mzk4Y2IzM2U4NDJhZSJ9fX0=",
            "ZmIxNjQ4NDgyNzMzYTdjM2JiODRiZTQ2OGQ1NzVlM2ZiZDNmZjE5MzI4MWIwNzI3ZWFkOGRlYWRlYTYwMjM3YSJ9fX0=")
    ),
    PARCHED(Arrays.asList(
