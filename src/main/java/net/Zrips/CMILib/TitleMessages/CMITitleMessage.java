...
public class CMITitleMessage {
	...
	if (Version.isCurrentHigher(Version.v1_7_R4)) {
		...
		try {
		    ...
		    sendPacket = net.minecraft.server.network.PlayerConnection.class.getMethod(Version.isCurrentEqualOrHigher(Version.v1_18_R1) ? "a" : "sendPacket", net.minecraft.network.protocol.Packet.class);
		} catch (Throwable e) {
		    e.printStackTrace();
		}
