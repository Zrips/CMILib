...
//    info_playerHeadName("{gcp}Head of &7[playerName]"),
    ...
    info_basicDirection("{gcp}Pitch:{gcs}[x] {gcp}Yaw:{gcs}[y]"),
    info_fullDirection("{gcp}Pitch:{gcs}[x] {gcp}Yaw:{gcs}[y] {gcp}Roll:{gcs}[z]"),
    info_basicScale("{gcp}Width:{gcs}[x] {gcp}Height:{gcs}[y]"),
    info_fullScale("{gcp}Width:{gcs}[x] {gcp}Height:{gcs}[y] {gcp}Depth:{gcs}[z]"),
    info_basicVector("{gcp}X:{gcs}[x] {gcp}Y:{gcs}[y]"),
