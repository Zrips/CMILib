...
public enum LC {
    ...
    info_prevPage("&2----<< [complex]&6Prev "),
    info_prevPageGui("&6Previous page "),
    info_prevPageClean("&6Prev "),
    info_prevPageOff("&2----<< [complex]&7Prev "),
    info_prevPageHover("&7<<<"),
    info_prevPageComplex("[value] :"),
    info_firstPageHover("&7|<"),
    info_nextPage("&6 Next[complex] &2>>----"),
    info_nextPageGui("&6Next Page"),
    info_nextPageClean("&6 Next"),
    info_nextPageOff("&7 Next[complex] &2>>----"),
    info_nextPageHover("&7>>>"),
    info_nextPageComplex(": [value]"),
