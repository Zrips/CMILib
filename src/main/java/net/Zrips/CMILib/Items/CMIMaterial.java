...
public enum CMIMaterial {
    ...
    // 1.20
    ACACIA_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    ACACIA_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    ...
    BAMBOO_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    BAMBOO_MOSAIC(),
    ...
    BAMBOO_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    BAMBOO_WALL_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    BIRCH_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    BIRCH_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    ...
    CHERRY_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    ...
    CHERRY_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    CHERRY_WALL_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    CHERRY_WOOD(),
    CHISELED_BOOKSHELF(),
    COAST_ARMOR_TRIM_SMITHING_TEMPLATE(CMIMC.TEMPLATE),
    CRIMSON_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    CRIMSON_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    DANGER_POTTERY_SHERD(CMIMC.SHERD),
    DARK_OAK_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    DARK_OAK_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    DECORATED_POT(),
    ...
    JUNGLE_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    MANGROVE_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    MANGROVE_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    ...
    OAK_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    ...
    SPRUCE_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    SPRUCE_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
    ...
    WARPED_HANGING_SIGN(CMIMC.SIGN, CMIMC.NOCOLLISIONBOX),
    WARPED_WALL_HANGING_SIGN(CMIMC.SIGN, CMIMC.WALLSIGN, CMIMC.NOCOLLISIONBOX),
